...
User.create(name: "Joshua Kappers", email: "jkappers@kalkomey.com", password: "1.kalkomey.1", vote_count: 100)
User.create(name: "Jay Sparks", email: "jsparks@kalkomey.com", password: "1.kalkomey.1", vote_count: 100)
User.create(name: "Bradley Griffith", email: "bgriffith@kalkomey.com", password: "1.kalkomey.1", vote_count: 100)
